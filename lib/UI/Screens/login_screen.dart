              ...
              children: [
                Padding(
                  padding: EdgeInsets.symmetric(
                      vertical: calculator.calculateResponsiveHeight(2)),
                  child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                string.stringsMap['login']['logloginHeading2'],
                    ...
                    child: Column(
                      children: [
                        Padding(
                            padding: EdgeInsets.symmetric(
                                vertical:
                                    calculator.calculateResponsiveHeight(3)),
                            child: Column(
                              children: [
                                Row(
                                  children: [
                                    SingleChildScrollView(
                                      ...
                                      child: Container(
                                        width: calculator
                                            .calculateResponsiveWidth(26),
                                        height: calculator
                                            .calculateResponsiveHeight(6),
                                          ...
                                          children: [
                                            ...
                                            Transform.translate(
                                              offset: const Offset(-25.0,
                                                  0), // Negative values for left and top
                                              child: const Icon(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          prefixIcon: Container(
                                            width: calculator
                                                .calculateResponsiveWidth(5),
                                            height: calculator
                                                .calculateResponsiveHeight(6),
                                            child: Align(
                                              alignment: Alignment.center,
                                              child: Text(
                                                loginMap['dialCode'].toString(),
                                                style: TextStyle(
                                                    color: Theme.of(context)
                                                        .primaryColor),
                                              ),
                                          ...
                                          labelText: string.stringsMap['login']
                                              ['loginPlaceHolder'],
                                        ),
                                        onChanged: (val) {
                                          if (val != '') {
                        ...
                        Padding(
                          padding: EdgeInsets.symmetric(
                              vertical:
                                  calculator.calculateResponsiveHeight(1.5)),
                          child: Button(
